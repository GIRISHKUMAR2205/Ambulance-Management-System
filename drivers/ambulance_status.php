...
<?php
$sql="select * from ambulances WHERE name='$name';";
$res=mysqli_query($db,$sql);
?>
<div style="padding-top:8%;">
<h2>Ambulance Status</h2><br>
<table class="table" >
<tr align="center">
    <th>Name</th>
    <th>PHONE NUMBER</th>
...
while($row = mysqli_fetch_array($res))
{
    ...
    <tr align="center">
        ...
        <td> <?php echo $row['status'];?><br><?php
        if($row['status']=="REJECTED")
        {?>
            <a href="ambulance_status.php?name=<?php echo $row['name']?>&del=delete" onClick="return confirm('Are you sure you want to reapply?')"class="btn btn-warning btn-xs tooltips" tooltip-placement="top" tooltip="Remove">REAPPLY</i></a>
            <?php
        }
            ?></td>
    </tr>
