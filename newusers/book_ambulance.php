...
<?php
$sql="select * from ambulances WHERE status='ADDED';";
$res=mysqli_query($db,$sql);
?>
<div style="padding-top: 8vw;">
<h2>Book Ambulance</h2><br>
<table class="table" >
<tr align="center">
    <th>Name</th>
    <th>PHONE NUMBER</th>
...
?>
    ...
    <tr align="center">
        ...
        <td>
            ...
            {?>
            <a href="book_ambulanceapp.php?vehicleno=<?php echo $row['vehicleno']?>" class="btn btn-warning" >BOOK AMBULANCE</i></a>
        <?php }?>
        </div></td>
    </tr>
